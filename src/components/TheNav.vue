<template>
  <div>
    <nav class="max-w-[800px] mx-auto text-center p-6 sm:p-6 relative">
      <i class="nav-icon fas fa-bars" @click="activeNav=!activeNav"
      :class="[activeNav ? 'rotate-90' : null]"></i>
        <ul class="nav-bar"
        :class="[activeNav ? ['!opacity-100','!pointer-events-auto'] : null]">
